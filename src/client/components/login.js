            ...
            <div className="col-md-4">
                <div className="login-panel panel panel-default">
                    <div className="panel-heading">
                        <h3 className="panel-title" align="center">Sign In</h3>
                    </div>
                            ...
                            <fieldset>
                                <div className="form-group">
                                    <input className="form-control" placeholder="E-mail"
                                           name="username" type="email" id={"username"} onChange={(ev) => setUser(ev.target.value)}/>
                                </div>
                                <div className="form-group">
                                    <input className="form-control" placeholder="Password"
                                           name="password" type="password" onChange={(ev) => setPass(ev.target.value)}/>
                                </div>
                                {error !== "" && <ErrorMessage msg={error}/>}
                                <div className="row justify-content-center" id="button" >
                                    <div className="col-5">
                                        <button className="btn btn-sm btn-success"
                                                style={{marginLeft: 40 + 'px'}} onClick={onSubmit}>Login
                                        </button>
                                        <div style={{marginTop: '5px'}}><a href="/register" style={{fontSize: '5px'}}>Don't have an account?</a></div>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
