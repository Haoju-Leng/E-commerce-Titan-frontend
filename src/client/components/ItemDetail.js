    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-7">
          ...
          <h2>stock</h2>
          <p>{item.stock}</p>
          <button className="btn btn-primary" onClick={handleButtonAddCart}>
            Add to Cart
          </button>
...
//             </div>
//             <div className="col-sm">divbb</div>
...
//   <a className="prev" onClick={() => setSlideNum(prevState => prevState - 1)}>&#10094;</a>
//   <a className="next" onClick={() => setSlideNum(prevState => prevState + 1)}>&#10095;</a>
...
//       <img className="demo cursor" src="img_woods.jpg" width="100%" onClick="currentSlide(1)" alt="The Woods"/>
//     </div>
//     <div className="column">
//       <img className="demo cursor" src="img_5terre.jpg" width="100%" onClick="currentSlide(2)" alt="Cinque Terre"/>
//     </div>
//     <div className="column">
//       <img className="demo cursor" src="img_mountains.jpg" width="100%" onClick="currentSlide(3)" alt="Mountains and fjords"/>
//     </div>
